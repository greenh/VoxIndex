...
public class JsAudioContext extends JsElementalMixinBase  implements AudioContext {
  ...
  public final native MediaStreamAudioSourceNode createMediaStreamSource(MediaStream stream) /*-{
  ...
  public final native ScriptProcessorNode createScriptProcessor(int bufferSize) /*-{
  	return this.createScriptProcessor(bufferSize); 
  }-*/;
  
  public final native ScriptProcessorNode createScriptProcessor(int bufferSize, int inputChannels) /*-{
  	return this.createScriptProcessor(bufferSize, inputChannels); 
  }-*/;
  public final native ScriptProcessorNode createScriptProcessor(int bufferSize, int inputChannels, int outputChannels) /*-{
