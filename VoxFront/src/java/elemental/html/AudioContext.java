...
public interface AudioContext extends EventTarget {
  ...
  ScriptProcessorNode createScriptProcessor(int bufferSize, int inputChannels);

  ScriptProcessorNode createScriptProcessor(int bufferSize, int inputChannels, int outputChannels);
