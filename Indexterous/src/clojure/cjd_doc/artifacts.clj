...
(defn parse-exin [form]
    (let [[_ name id-fn &composed-extensos &local-fields & local-protos-methods] form
          artifact (make-artifact)
          unparsed-forms (parse-method-implementations artifact local-protos-methods)
          poioos (parse-poioos artifact unparsed-forms)]
      (set-poioos artifact poioos)
...
(defartifact Exin defexin "exin" 
  [HasMethodImplementations HasPoioos] [] parse-exin)
